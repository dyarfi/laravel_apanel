...
<div class="container-fluid">
    ...
    @if ($participant->roles->first())
    <?php /* @if ($participant->permissions) */ ?>
        <div class="container-fluid">
            <div class="col-lg-8">
            {!! Form::open(['route'=>['admin.permissions.change',$participant->id],'method'=>'POST','class'=>'form-horizontal','role'=>'form','id'=>'permissions_update']) !!}
                            ...
                            <div class="checkbox-handler">   
                                @foreach ($values as $b => $key_access)
                                    ...
                                    foreach (current($tmp)['method'] as $access) {                        
                                        ...
                                        @if (array_get($participant->permissions, $access))
    ...
    */
    ...
    <div class="row">
        <div class="col-md-5 col-xs-6">
            ...
            <a href="{{ route('users.edit', $participant->id) }}" class="btn btn-primary btn-xs">Edit user</a>
        </div>
        <div class="col-md-5 col-xs-6 text-right">
            {!! Form::open([
                'method' => 'DELETE',
                'route' => ['users.destroy', $participant->id]
            ]) !!}
