    ...
    <div id="navbar" class="navbar navbar-default">
      ...
      <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
          <a href="{{ URL::to('apanel') }}" class="navbar-brand">
            <small>
  	...
  	<div class="container">
  		...
  		<nav class="navbar xnavbar-fixed-top navbar-inverse" role="navigation">
  			...
  			<div class="collapse navbar-collapse navbar-ex1-collapse">
  				...
  				<ul class="nav navbar-nav">
  					...
  					@if ( ! Sentinel::check() )
  					<li{{ Request::is('login') ? ' class="active"' : null }}><a href="{{ URL::to('apanel/login') }}">Login</a></li>
  					<li{{ Request::is('register') ? ' class="active"' : null }}><a href="{{ URL::to('apanel/register') }}">Register</a></li>
  					@elseif (Sentinel::hasAccess('admin'))
  					<li{{ Request::is('users*') ? ' class="active"' : null }}><a href="{{ URL::to('apanel/users') }}">Users</a></li>
  					<li{{ Request::is('roles*') ? ' class="active"' : null }}><a href="{{ URL::to('apanel/roles') }}">Roles</a></li>
  					@endif
            <li><a href="{{ URL::to('apanel/pages') }}">Pages</a></li>
  				</ul>
          <ul class="nav navbar-nav pull-right">
            <li><a href="https://cartalyst.com/manual/sentinel">Manual</a></li>
  				...
  				<li><a href="{{ URL::to('apanel/logout') }}">Logout</a></li>
  				@endif
          </ul>
